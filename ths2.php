...
<html lang="hu">
  <head>
    ...
    <title>Köszönjük! Rendelését felvettük!</title>
    ...
    <div class="left">
      <div class="header">
        <div class="title">
          ...
          Rendelését felvettük!
        </div>
        <span>
		Ügyintézőnk felveszi Önnel a kapcsolatot a megrendelés jóváhagyása céljából.
        </span>
      </div>

      <div class="form">
        <p>Kérjük, ellenőrizze a megadott adatok pontosságát.</p>
        <div class="form-wrap">
          <div class="wrap-input">
            <div class="input">
              <label for="name">Utónév</label>
          ...
          <form
            class="hidden-form" id="form" geo="hu" action="api.php" method="post" 
	onsubmit="return validate_form(this, 'Kérjük adjon meg egy érvényes telefonszámot');">
			
            <input type="text" name="name" required="" placeholder="Utónév" />
